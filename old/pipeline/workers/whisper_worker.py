...
class WhisperWorker:
    ...
    def align(
        ...
        align_kwargs = dict(
            ...
            max_word_dur=self._config.max_word_dur,
            remove_instant_words=self._config.remove_instant_words,
            original_split=self._config.original_split,
        )
        if self._config.failure_threshold is not None:
            align_kwargs["failure_threshold"] = self._config.failure_threshold
